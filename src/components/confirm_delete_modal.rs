    ...
    if *props.is_visible.read() {
        rsx! {
            ...
            div {
                ...
                div {
                    class: "bg-section border border-faint rounded-lg shadow-xl p-4 w-sm",
                    tabindex: "0",
                    ...
                    if props.show_dont_ask_again {
                        div {
                            ...
                            input {
                                id: "remember_choice",
                                "type": "checkbox",
                                class: "h-4 w-4 text-purple-600 bg-input border-faint rounded focus:ring-purple-500",
                    ...
                    div {
                        ...
                        button {
                            class: "px-4 py-2 bg-input rounded-md text-fg font-semibold hover:bg-input focus:outline-none focus:ring-2 focus:ring-gray-500",
                            onclick: move |_| props.on_cancel.call(()),
                            "Cancel"
                        }
                        button {
                            class: "px-4 py-2 bg-red-600 rounded-md text-fg font-semibold hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500",
